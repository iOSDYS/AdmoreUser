#
# Be sure to run `pod lib lint AdmoreUser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AdmoreUser'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AdmoreUser.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'AdmoreUser/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AdmoreUser' => ['AdmoreUser/Assets/*.png']
  # }
